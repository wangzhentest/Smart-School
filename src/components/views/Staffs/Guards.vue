<template>
  <div class="main">
    <div class="search-bar">
      ...
      <el-button style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);" disabled="0">安保人员</el-button>
    </div>
    <div class="descriptionsArea">
      ...
      <el-descriptions size="large" border style="margin-left:1%;margin-right:1%;width: 98%;margin-bottom: 1%" v-for="(item,index) in tableData" :key="index">
        <el-descriptions-item >
          ...
          <el-input style="width: 180px;" :readonly="true" :model-value="item.guard_id"/>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label>
            <el-icon :size="20">
          ...
          <el-input style="width: 180px;" :readonly="true" :model-value="item.guard_name"/>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label>
            <el-icon :size="20">
            ...
            <span style="font-size: 18px">&nbsp;负责区域</span>
          </template>
          <el-tag size="large">&nbsp;{{item.guard_office}}</el-tag>
        </el-descriptions-item>
        ...
        <el-descriptions-item>
          ...
          <el-input style="width: 180px;" :readonly="true" :model-value="item.guard_age"/>
        </el-descriptions-item>
        ...
        <el-descriptions-item>
          ...
          <el-input style="width: 180px;" :readonly="true" :model-value="item.guard_sex"/>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label>
            <el-icon :size="20">
          ...
          <el-input style="width: 180px;" :readonly="true" :model-value="item.guard_phone"/>
        </el-descriptions-item>
      </el-descriptions>
    </div>
  </div>
...
const get_guards = async () => {
  tableData.value = await apiService.get_guards();
};
